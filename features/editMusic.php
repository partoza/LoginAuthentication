    ...
    <div class="container mt-5">
        ...
        <div class="contanier ps-md-2">
            ...
            <div class="row">
                ...
                $stmt = $conn->prepare("SELECT * FROM music WHERE userID = ? ORDER BY favorite DESC, musicID DESC");
                                            ...
                                            <form class="form" action="../actions/editMusic_action.php"
                                                ...
                                                <div class="row d-flex justify-content-between">
                                                    ...
                                                    <div class="col-12 mt-4">
                                                        <button class="btn form-control text-white"  style="width: 100%; background-color: #1ED760; transition: background-color 0.3s;" type="submit"
