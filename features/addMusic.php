    ...
    <div class="container mt-5">
        ...
        <div class="contanier ps-md-2">
            <div class="row ps-md-2">
                <div class="col-12 d-flex justify-content-center justify-content-md-start mt-2 mt-md-3 mb-md-3" id="list2
                    .087.enMusic">
                ...
                <div class="row ms-1">
                    ...
                    <div class="row">
                        ...
                        $stmt = $conn->prepare("SELECT * FROM music WHERE userID = ? ORDER BY musicID DESC");
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <div class="col-12 col-sm-6 col-md-3 mt-3 d-flex justify-content-center">
                                    <div class="card bg-dark text-white" style="width: 18rem;" type="button" data-toggle="modal"
                                        ...
                                        <img src="../actions/<?php echo htmlspecialchars($coverImagePath); ?>"
                                            class="card-img-top" alt="Cover Image" style="width: 100%; height: 230px">
                                        <div class="card-body">
