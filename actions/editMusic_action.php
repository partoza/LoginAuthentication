...
try {
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        $stmt = $conn->prepare("SELECT coverimage, audio FROM music WHERE musicid = ?");
        ...
        $stmt = $conn->prepare("UPDATE music SET title = ?, shortdescription = ?, artist = ?, featartist = ?, coverimage = ?, audio = ?, favorite = ? WHERE musicid = ?");
